...
<head>
    ...
    <!-- Link to external CSS (Consider consolidating styles here) -->
    <!-- <link rel="stylesheet" href="profile-styles.css"> --> <!-- If you have one -->
    ...
    <!-- Start of your large inline style block -->
    <style>
        /* ======================================== */
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        main { flex-grow: 1; padding: 0; } /* Main content takes remaining height */
        ...
        .btn-accept {
             ...
             color: white !important; /* Override potential inheritance */
             border: 1px solid #28a745;
        }
        .btn-accept:hover:not(:disabled) {
             background-color: #218838;
             border-color: #1e7e34;
             box-shadow: none; /* Remove orange shadow */
        }
        .btn-decline, .btn-cancel, .btn-remove {
        ...
        .profile-container {
            max-width: 800px;
            margin: 3rem auto; /* Center profile box, provide spacing */
            padding: 2.5rem 3rem;
        ...
        .profile-container.has-background::before {
            opacity: 0.5; /* Show with opacity */
        }
        /* Profile content should be above the background */
        .profile-container > *:not(::before) {
            position: relative;
            z-index: 2;
        }
        ...
        #profile-pic #profile-initials { /* Style for the initials span */
            font-size: 4.5rem;
            font-weight: 700;
            line-height: 1;
        ...
        #profile-username { font-size: 2.2rem; font-weight: 700; color: var(--text-light); margin: 0; word-break: break-word;}
        #profile-badges-container { display: inline-flex; align-items: center; gap: 0.4rem; line-height: 1; vertical-align: middle; flex-shrink: 0; }
        .profile-badge { display: inline-flex; align-items: center; justify-content: center; width: 1.8em; height: 1.8em; border-radius: 50%; font-size: 0.8em; font-weight: bold; color: var(--badge-tick-color); line-height: 1; vertical-align: middle; position: relative; }
        ...
        .admin-tag { display: none; background-color: var(--primary-orange); color: var(--text-dark); padding: 0.3em 0.6em; border-radius: var(--border-radius-sm); font-size: 0.8rem; font-weight: 700; text-transform: uppercase; vertical-align: middle; line-height: 1; flex-shrink: 0; margin-left: 0.3rem; /* Add some space */ }

        #profile-email {
            display: none; /* Hides the email display element */
            font-size: 1rem;
        ...
        .profile-stats, .profile-section /* Common class for section blocks INSIDE profile box */
        {
            margin-top: 2.5rem;
        ...
        .stats-grid > p { color: var(--text-secondary); font-style: italic; grid-column: 1 / -1; text-align: center; padding: 1rem 0; } /* For loading/error messages */
        ...
        /* General Loading / Not Logged In / Empty List Messages */
        #loading-profile, #not-logged-in, .list-message {
            color: var(--text-secondary);
            font-style: italic;
            text-align: center;
            padding: 1rem;
        }
         #loading-profile, #not-logged-in { /* Specific full page messages */
            max-width: 800px;
            margin: 3rem auto;
            padding: 4rem 2rem;
         ...
         .list-message { /* Used within lists */
            justify-content: center; /* Center message text */
            border-bottom: none !important; /* Override list item border */
        }
        .list-message:hover {
            background-color: transparent !important; /* Override hover if needed */
        }
        ...
        .title-option:disabled { color: var(--text-secondary); cursor: default; opacity: 0.7; } /* Style for disabled equipped title */
        ...
        .btn .spinner { border-top-color: currentColor; } /* Inherit color for spinner on btn */

        /* ======================================== */
        /* Friend System Styles                   */
        /* ======================================== */
        #friendship-controls-container { /* Specific container for buttons below name/rank */
             margin-top: 1rem;
             min-height: 40px; /* Prevent layout shift when buttons appear/disappear */
             display: flex;
             justify-content: center;
             gap: 0.5rem;
         }
        #friendship-controls-container button {
             margin-right: 0; /* Reset default margin */
         }

        /* #friends-section inherits .profile-section styles */
        #friends-section h3 { text-align: center; margin-bottom: 1.5rem; }
        #friends-section h4 { /* Specific headers within friends section */
            color: #ccc;
            font-size: 1.1rem;
            margin-bottom: 1rem;
        ...
        /* ======================================== */
        /* Achievements Section Styles (Moved Outside) */
        /* ======================================== */
        /* Wrapper for Full-Width Section */
        .achievements-container-wrapper {
            width: 100%;
            background-color: var(--dark-card); /* Background for the whole achievement area */
            padding: 3rem 1rem;
            margin-top: 3rem; /* Space below profile box */
            border-top: 1px solid var(--border-light); /* Separator line */
            box-sizing: border-box;
        }

        /* Inner container to limit content width */
        .achievements-content-limiter {
            max-width: 900px; /* Can be wider than profile box */
            margin: 0 auto; /* Center content */
        }

        /* Reset inherited styles for #achievements-section when inside wrapper */
        .achievements-container-wrapper #achievements-section {
            margin-top: 0;
            padding-top: 0;
            border-top: none;
            text-align: left;
        ...
        /* Keep h3 centered within the achievement section */
        ...
        @media (max-width: 768px) {
            ...
            #achievements-section h3 { font-size: 1.5rem; } /* Target achievement header specifically */
         ...
         @media (max-width: 480px) {
            main { padding: 0 0.5rem; } /* Slight horizontal padding for main on mobile */
            ...
            #profile-email { font-size: 0.9rem; /* Kept for reference */ }
            .profile-stats, .profile-section { padding-top: 1.8rem; margin-top: 1.8rem; }
            .profile-stats h3, .profile-section h3 { font-size: 1.4rem; margin-bottom: 1.5rem; }
            #achievements-section h3 { font-size: 1.4rem; margin-bottom: 1.5rem; } /* Target achievement header */
     ...
     <!-- End of your large inline style block -->
</head>
<body>
    <!-- Header -->
    <header>
    ...
    <main>
        ...
        <div class="profile-container" id="profile-content" style="display: none;">
            <div class="profile-header">
                ...
                <div>
                    ...
                    <!-- Friend Action Buttons Container -->
                    <div id="friendship-controls-container">
                        <!-- Friend buttons added here by JS -->
                    </div>
                    <p id="profile-email">useremail@example.com</p> <!-- Still hidden by CSS -->
                </div>
            </div>
            ...
            <div class="profile-section" id="friends-section" style="display: none;">
                ...
                <div class="tab-content active" id="friends-list-container">
                    ...
                    <ul class="friend-request-list" id="friends-list">
                        <li class="list-message">Loading friends...</li>
                    </ul>
                </div>
                <div class="tab-content" id="incoming-requests-container">
                    <h4>Incoming Requests</h4>
                    <ul class="friend-request-list" id="incoming-requests-list">
                         <li class="list-message">Loading incoming requests...</li>
                    </ul>
                </div>
                <div class="tab-content" id="outgoing-requests-container">
                    <h4>Outgoing Requests</h4>
                    <ul class="friend-request-list" id="outgoing-requests-list">
                        <li class="list-message">Loading outgoing requests...</li>
                    </ul>
                </div>
            </div>
            <!-- *** End of Friends Section (inside profile box) *** -->
        ...
        <!-- === NEW Achievements Section Wrapper (Outside main profile box) === -->
        <div class="achievements-container-wrapper" id="achievements-section-outer" style="display: none;">
             <div class="achievements-content-limiter"> <!-- Inner div to control content width -->
                 <!-- This is the MOVED achievements block -->
                <div class="profile-section" id="achievements-section"> <!-- Use ID for internal logic -->
                    <h3>My Achievements</h3>
                    <div class="achievements-list" id="achievements-list-container">
                        <p class="list-message">Loading achievements...</p>
                        <!-- Achievement items will be added here by JS -->
                    </div>
                </div>
            </div>
        </div>
        <!-- === End of Achievements Section Wrapper === -->
    ...
    <!-- Cloudinary Script (Optional if using Fetch API only) -->
